...
import { MessageCircle, Users, Bike, Waves } from 'lucide-react';

const Alleppey = () => {
  const activities = [
    {
      name: 'Houseboats',
      description: 'Traditional houseboats with full amenities floating through peaceful backwaters',
      icon: Waves,
    },
    {
      name: 'Backwater Cruises',
      description: 'Day cruises through network of canals, lakes and coconut palm-lined waterways',
      icon: Waves,
    },
    {
      name: 'Kayaking',
      description: 'Glide through backwaters on a kayak, where calm waters meet endless coconut shores',
      icon: Users,
    },
  ];
    ...
    <Layout>
      ...
      <section className="relative h-screen flex items-start justify-center overflow-hidden pt-32">
        <div 
          ...
          style={{ backgroundImage: `url(${alleppeyImage})` }}
        >
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl font-light mb-8">
            Slow water, palm trees, and homes on the backwaters.
          </p>
          {/* <Button 
            variant="whatsapp" 
            size="lg"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Drift through Kerala's peaceful waterways and experience life at a slower pace.
            </p>
          </div>
              ...
              <div className="flex items-center justify-between flex-wrap gap-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Explore Kerala's coastal roads and village paths at your pace</p>
                  </div>
                </div>
                <Button 
                  variant="default" 
      ...
      <section className="py-16 bg-gradient-to-r from-himalayan-blue to-sunset-orange">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl text-white/90 mb-8">
            Our Tribe is here 24/7 to help you plan the perfect backwater escape
          </p>
          <Button 
            variant="whatsapp" 
            size="lg"
